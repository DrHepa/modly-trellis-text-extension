...
WORK_DIR="native-wheels/work/nvdiffrast-linux"
TORCH_VERSION="2.7.0"
...
"$VENV_PYTHON" -m pip wheel "$REPO_DIR" --no-build-isolation -w "$OUT_DIR"

echo "[native-wheels] nvdiffrast wheel build complete: $OUT_DIR"
