...
The workflow builds `cp311` and `cp312` wheels on `windows-2022`, installs CUDA Toolkit 12.8, runs the smoke test, and optionally uploads the wheels plus license files to the release tag.
